...
This project follows a **Test-Documentation-Regression (TDR) Workflow** to ensure quality and prevent regressions.
...
- Use `@pytest.mark.critical` for essential functionality
- Ensure minimum 15% code coverage

#### **2. 🛠️ Implement Feature**
```bash
# Implement the feature
src/uvr_pyside6_ui/[module]/[feature].py
```
- Follow MVP pattern architecture
- Use proper signal/slot communication
...
- Add usage examples
- Update feature matrices and status

#### **4. 🔍 Regression Testing**
```bash
# Run comprehensive quality checks
make test-critical          # Ensure no critical functionality broken
