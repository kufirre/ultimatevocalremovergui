...
class DownloadWorker(QObject):
    ...
    def __init__(self, model_name: str, download_url: str, model_type: str, 
    ...
    def run(self):
        ...
        try:
            ...
            success, model_path_or_msg, config_path = model_downloader.download_model_file(
                self.model_name, 
                self.download_url, 
                self.model_type,
                self.config_url,
            ...
            if success:
                ...
                self.finished.emit(True, model_path_or_msg, 
                                  config_path if config_path else "", message)
            else:
...
class DownloadManager(QObject):
    ...
    download_finished = Signal(bool, str, str, str)  # success, model_path, config_path, message
    ...
    def start_download(self, model_name: str, download_url: str, model_type: str, 
                      config_url: Optional[str] = None):
