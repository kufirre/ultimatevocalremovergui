...
class AudioAlignmentView(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        manual_controls_layout.addRow(
            self.phase_correction_label, self.phase_correction_combo
        )
        ...
        advanced_layout.addRow(
            self.correlation_window_label, self.correlation_window_combo
        )
    ...
    def set_settings(self, settings):
        ...
        if "correlation_window" in settings:
            index = self.correlation_window_combo.findText(
