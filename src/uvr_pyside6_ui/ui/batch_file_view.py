...
class BatchFileView(QWidget):
    ...
    def _setup_ui(self):
        ...
        # Info label
        self.info_label = QLabel("Add audio files to process multiple files in sequence")
        ...
        self.add_files_button.setToolTip("Add individual audio files to the batch queue")
        try:
        ...
        self.add_folder_button.setToolTip("Add all audio files from a folder to the batch queue")
