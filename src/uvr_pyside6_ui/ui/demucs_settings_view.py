...
class AdvancedDemucsSettingsView(QDialog):
    ...
    def _setup_ui(self):
        ...
        self.primary_stem_combo.addItems(["All Stems", "Vocals", "Other", "Bass", "Drums"])
        ...
        self.shifts_slider.valueChanged.connect(lambda v: self.shifts_value_label.setText(str(v)))
        ...
        self.secondary_model_combo.addItems(["None", "htdemucs", "htdemucs_ft", "htdemucs_6s"])
