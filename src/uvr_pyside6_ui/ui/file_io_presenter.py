...
class FileIOPresenter(QObject):
    ...
    def __init__(self, view):
        ...
        print("FileIOPresenter Initialized.")

    @Slot()
    def handle_select_input(self):
        """Handles the 'Browse...' click for input."""
        print("Presenter: Input browse clicked. Telling View to show dialog.")
    ...
    def handle_select_output(self):
        ...
        print("Presenter: Output browse clicked. Telling View to show dialog.")
    ...
    def handle_input_path_update(self, path):
        ...
        if self._input_path != path:
            ...
            print(f"Presenter: Input path is now '{self._input_path}'")
    ...
    def handle_output_path_update(self, path):
        ...
        if self._output_path != path:
            ...
            print(f"Presenter: Output path is now '{self._output_path}'")
