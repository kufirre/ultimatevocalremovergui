...
class TestDemucsSecondaryStemFix:
    ...
    def test_secondary_stem_logic_for_drums_primary(self):
        ...
        assert should_create_secondary == False, \
    ...
    def test_secondary_stem_logic_for_vocals_primary(self):
        ...
        assert should_create_secondary == True, \
    ...
    def test_demucs_separator_drums_processing_mock(self):
        ...
        with patch.object(separator, '_write_stem') as mock_write_stem:
            ...
            if not mock_model_data.is_primary_stem_only and not mock_model_data.secondary_stem.startswith("No "):
    ...
    def test_demucs_separator_vocals_processing_mock(self):
        ...
        with patch.object(separator, '_write_stem') as mock_write_stem:
            ...
            mock_write_stem.assert_called_once_with("Instrumental", mock_write_stem.call_args[0][1], 44100)

    @pytest.mark.parametrize("primary_stem,secondary_stem,should_create", [
        ("Drums", "No Drums", False),
        ("Bass", "No Bass", False),  
        ("Other", "No Other", False),
        ("Vocals", "Instrumental", True),
    ])
    def test_parametrized_secondary_stem_creation_logic(self, primary_stem, secondary_stem, should_create):
        ...
        assert actual_should_create == should_create, \
    ...
    def test_edge_case_unusual_secondary_stem_names(self):
        ...
        unusual_cases = [
            ...
            ("Not a No stem", True),    # Contains "No" but doesn't start with "No " - should create
        ]
    ...
    def test_regression_no_crash_on_single_instrument_separation(self):
        ...
        try:
            ...
            should_create_secondary = not mock_model_data.secondary_stem.startswith("No ")
            
            # Should succeed without AttributeError
            assert should_create_secondary == False  # "No Drums" should not create secondary
