...
from uvr_pyside6_ui.core.processing_worker import RealProcessingWorker, ProcessingThread
...
class TestRealProcessingWorker:
    ...
    def test_run_missing_audio_file(self, valid_settings_dict, mock_model_data):
        ...
        with patch('uvr_pyside6_ui.core.processing_worker.SeperateVRLogic', Mock()):
            with patch('uvr_pyside6_ui.core.processing_worker.SeperateMDXLogic', Mock()):
                with patch('uvr_pyside6_ui.core.processing_worker.SeperateMDXCLogic', Mock()):
                    with patch('uvr_pyside6_ui.core.processing_worker.SeperateDemucsLogic', Mock()):
                        with patch('uvr_pyside6_ui.core.processing_worker.clear_gpu_cache_logic', Mock()):
                            with patch('uvr_pyside6_ui.core.processing_worker.prepare_mix_logic', Mock()):
                                with patch('uvr_pyside6_ui.core.processing_worker.write_audio_logic', Mock()):
    ...
    def test_run_missing_export_path(self, valid_settings_dict, mock_model_data, mock_audio_file):
    ...
    def test_run_ensemble_processing(self, ensemble_settings_dict, mock_model_data, mock_audio_file, temp_dir):
    ...
    def test_spectral_ensemble_max(self, valid_settings_dict):
        ...
        with patch('uvr_pyside6_ui.core.processing_worker.spec_utils') as mock_spec_utils:
            ...
            mock_spec_utils.spectrogram_to_wave_old.return_value = np.random.rand(2, 1000).astype(np.float32)
    ...
    def test_create_process_data_default(self, valid_settings_dict, mock_model_data, mock_audio_file, temp_dir):
    ...
    def test_create_process_data_with_input_audio(self, valid_settings_dict, mock_model_data, temp_dir):
        ...
        assert process_data['audio_file_base'] == "test"  # Uses filename from audio_file path

    def test_create_process_data_for_chained_model(self, valid_settings_dict, mock_model_data, temp_dir):
...
class TestProcessingThread:
    ...
    def test_thread_run_successful(self, valid_settings_dict):
        ...
        with patch('uvr_pyside6_ui.core.processing_worker.RealProcessingWorker', return_value=mock_worker):
            thread.run()
    ...
    def test_thread_run_with_exception(self, valid_settings_dict):
        ...
        with patch('uvr_pyside6_ui.core.processing_worker.RealProcessingWorker') as mock_worker_class:
